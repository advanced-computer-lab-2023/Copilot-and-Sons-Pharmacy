...
export const addToCart = asyncWrapper(
 ...
 export const  viewCart = asyncWrapper(
    async (req: Request, res: Response) => {
                // const username = req.username;  
        //////////////////////////////////////////////////////
        //rember to use authentiaction for now assume that will send in headers
 ...
 export const  removeItemFromCart=asyncWrapper( async (req: Request, res: Response) => {
    ...
    //////////////////////////////////////////////////////////////////
   const cart= await removeItemFromCartService(req.body.medicineId,req.username);
   res.json({ success: SUCCESS, data: cart });
...
export const changeCartItemQuantity=asyncWrapper( async (req: Request, res: Response) => {
