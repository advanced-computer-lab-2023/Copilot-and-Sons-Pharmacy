import Joi from 'joi';
import { isStrongPassword,getPasswordStrengthReason } from './password.validator';
...
const registrationValidator = Joi.object({
  ...
  mobileNumber: Joi.string()
    ...
    .required()
    .messages({
      'string.pattern.base': 'Mobile number should be a 10-digit numeric string',
  ...
  emergencyContact: Joi.object({
    ...
    mobileNumber: Joi.string()
      ...
      .required()
      .messages({
        'string.pattern.base': 'Emergency contact mobile number should be a 10-digit numeric string',
