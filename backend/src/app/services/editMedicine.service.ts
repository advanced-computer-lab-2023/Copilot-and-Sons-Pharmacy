...
export const editMedicineService = async (
  ...
  try {
    ...
    existingMedicine.description = updatedMedicineData.description || existingMedicine.description;
    existingMedicine.quantity = updatedMedicineData.quantity || existingMedicine.quantity;
    existingMedicine.Image = updatedMedicineData.Image || existingMedicine.Image;
    existingMedicine.activeIngredients = updatedMedicineData.activeIngredients || existingMedicine.activeIngredients;
    existingMedicine.medicinalUse = updatedMedicineData.medicinalUse || existingMedicine.medicinalUse;
