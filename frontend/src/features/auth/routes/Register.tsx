...
import PharmacyRegister from './pharmacistRequest' // Import your first component
import RegistrationForm from './RegistrationForm' // Import your second component
...
const Register: React.FC = () => {
  ...
  const handleAvatarClick1 = () => {
    ...
    setSelectedComponent(isBadgeVisible1 ? null : <PharmacyRegister />)
  }
  ...
  const handleAvatarClick2 = () => {
    ...
    setSelectedComponent(isBadgeVisible2 ? null : <RegistrationForm />)
  }
    ...
    >
      ...
      >
        <div style={{ textAlign: 'center', marginRight: '20px' }}>
          <h4 style={{ color: colorprimary }}>Pharmacist</h4>
          <Badge
            overlap="circular"
            anchorOrigin={{
              vertical: 'bottom',
